...
class Settings:
    ...
    research_model_groq: str = os.getenv("RESEARCH_MODEL_GROQ", "llama-3.3-70b-versatile")
    analysis_model_openrouter: str = os.getenv("ANALYSIS_MODEL_OPENROUTER", "llama-3.3-70b-versatile")
    visual_model_openrouter: str = os.getenv("VISUAL_MODEL_OPENROUTER", "llama-3.3-70b-versatile")
    translation_model_sarvam: str = os.getenv("TRANSLATION_MODEL_SARVAM", "sarvam-translate")
    ...
    groq_model_long_context: str = os.getenv("GROQ_MODEL_LONG_CONTEXT", "llama-4-scout-17b")

    # OpenRouter free-tier options
    openrouter_model_strong_free: str = os.getenv("OPENROUTER_MODEL_STRONG_FREE", "nvidia/nemotron-3-super-120b")
    openrouter_model_coding_free: str = os.getenv("OPENROUTER_MODEL_CODING_FREE", "mistralai/devstral-2512")
    openrouter_model_fast_free: str = os.getenv("OPENROUTER_MODEL_FAST_FREE", "stepfun/step-3.5-flash")
    openrouter_model_multimodal_free: str = os.getenv("OPENROUTER_MODEL_MULTIMODAL_FREE", "google/gemma-3-27b-it")
    openrouter_model_auto_free: str = os.getenv("OPENROUTER_MODEL_AUTO_FREE", "openrouter/free")
    ...
    agentic_enable_crewai: bool = _as_bool(os.getenv("AGENTIC_ENABLE_CREWAI", "true"), default=True)
    ...
    behavior_memory_enabled: bool = _as_bool(os.getenv("BEHAVIOR_MEMORY_ENABLED", "true"), default=True)
    behavior_memory_collection: str = os.getenv("BEHAVIOR_MEMORY_COLLECTION", "ray_behavior")
