...
from core.assistant_contract import build_assistant_contract
from core.state import AgentState
from core.llm_factory import LLMFactory
from core.runtime import load_user_settings
from core.visual_output import build_visual_output_guidance
...
def composer(state: AgentState) -> dict:
    ...
    deep_research_summary = state.get("deep_research_summary", "")
...
Crawl4AI scraped pages: {len(scraped_data)}
Crawl4AI synthesis available: {bool(deep_research_summary)}

EVIDENCE:
{evidence_block}

FIRECRAWL SYNTHESIS:
{deep_research_summary[:4000] if deep_research_summary else 'No Crawl4AI scrape summary available.'}"""
